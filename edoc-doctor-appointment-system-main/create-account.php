...
?>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="tel" id="tele" name="tele" class="input-text"  placeholder="ex: 7123456789" pattern="[0-9]{10}" >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
...
document.querySelector('form').addEventListener('submit', function(event) {
    ...
    var val = teleInput.value.trim();
    if (val.length === 10 && !val.startsWith('+91')) {
        teleInput.value = '+91' + val;
    }
});
</script>
</body>
